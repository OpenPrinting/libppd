     ...
     if ((current_res = cfNewResolutionArray()) != NULL)
      {
        ...
        //Checking if there is printer-default-resolution and this resolution is in the list, use it. If not, use the middpi ,
        // rounding down if the number of available resolutions is even.
