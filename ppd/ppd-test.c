                      ...
                      cups_array_t *file_array)    // Array consisting of filenames of the ppd files to be checked 
{
  ...
  for (i = 1; i <= files; i++)
  {
    ...
    else
    {
      if (verbose > 0)
      {
        ppdArrayAdd(output, "        PASS    DefaultImageableArea");
      ...
      {    
        ppdArrayAdd(output, "        PASS    DefaultPaperDimension");
        ...
        if ((attr = ppdFindAttr(ppd, "FileVersion", NULL)) != NULL)
        {
          for (ptr = attr->value; *ptr; ptr++)
            ...
            {
              ppdArrayAdd(output, "        PASS    FileVersion");
        ...
        if ((attr = ppdFindAttr(ppd, "FormatVersion", NULL)) != NULL)
        {
          ptr = attr->value;
            ...
            {
              ppdArrayAdd(output, "        PASS    FormatVersion");
        ...
        if (ppd->lang_encoding != NULL)
        {
          if (verbose > 0)
          {
            ppdArrayAdd(output, "        PASS    LanguageEncoding");
        ...
        if (ppd->lang_version != NULL)
        {
          if (verbose > 0)
          {
            ppdArrayAdd(output, "        PASS    LanguageVersion");
        ...
        if (ppd->manufacturer != NULL)
        {
          ...
          {
            ppdArrayAdd(output, "        PASS    Manufacturer");
        ...
        if (ppd->modelname != NULL)
        {
          ...
          {
            ppdArrayAdd(output, "        PASS    ModelName");
        ...
        if (ppd->nickname != NULL)
        {
          if (verbose > 0)
          {
            ppdArrayAdd(output, "        PASS    NickName");
        ...
        if (ppdFindOption(ppd, "PageSize") != NULL)
        {
          if (verbose > 0)
          {
            ppdArrayAdd(output, "        PASS    PageSize");
        ...
        if (ppdFindOption(ppd, "PageRegion") != NULL)
        {
          if (verbose > 0)
          {
              ppdArrayAdd(output, "        PASS    PageRegion");
        ...
        if (ppd->pcfilename != NULL)
        {
          if (verbose > 0)
          {
            ppdArrayAdd(output, "        PASS    PCFileName");
        ...
        if (ppd->product != NULL)
        {
          ...
          {
              ppdArrayAdd(output, "        PASS    Product");
             ...
             attr->value != NULL)
        {
          ...
          {
              ppdArrayAdd(output, "        PASS    PSVersion");
        ...
        if (ppd->shortnickname != NULL)
        {
          ...
          {
              ppdArrayAdd(output, "        PASS    ShortNickName");
       ...
       // PaperDimension values...
        ...
        if (verbose > 0)
        {
          if (errors)
          {
            ...
            {
            ppdArrayAdd(output, "    NO ERRORS FOUND");
